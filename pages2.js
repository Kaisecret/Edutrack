...
function parentGrades() {
    ...
    <div class="row g-4"><div class="col-md-6"><div class="edutrack-card stat-soft-card stat-soft-card-success text-center py-4"><h2 class="fw-bold stat-soft-value stat-soft-value-success mb-0">3.88</h2><p class="text-muted mt-2 mb-0">Cumulative GPA</p></div></div>
    <div class="col-md-6"><div class="edutrack-card stat-soft-card stat-soft-card-primary text-center py-4"><h2 class="fw-bold stat-soft-value stat-soft-value-primary mb-0">91.7%</h2><p class="text-muted mt-2 mb-0">Overall Average</p></div></div></div>`;
}
...
function parentAlerts() {
    ...
    <div class="edutrack-card">
        ...
        <div class="d-flex gap-3 p-3 bg-warning bg-opacity-10 rounded mb-3 align-items-start"><div class="notif-icon bg-warning bg-opacity-10 text-warning"><i class="fas fa-calendar-days"></i></div><div class="flex-grow-1"><div class="d-flex justify-content-between"><h6 class="fw-bold mb-1 text-warning">Assignment Deadline</h6><span class="badge bg-warning text-dark">Important</span></div><p class="text-muted small mb-1">Persona Mapping Case Study is due in 2 days. Check in with Venus on progress.</p><small class="text-muted">5 hours ago</small></div></div>
